...
def get_args():
    ...
    parser.add_argument('--model_dir', type=str, default='./model/qmix', help='the model directory of the policy')
    parser.add_argument('--result_dir', type=str, default='./model/qmix', help='the result directory of the policy')
    ...
    parser.add_argument('--learn', type=bool, default=False, help='how often to update the target_net')
